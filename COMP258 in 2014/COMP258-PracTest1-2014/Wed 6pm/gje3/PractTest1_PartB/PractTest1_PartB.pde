...
// References to the start and finish tokens and maze
...
void setup() {
  ...
  gameMaze = new Maze();
  //create obstacles
  gameMaze.addObstacle(100,100,100,100);
  gameMaze.addObstacle(500,500,100,200);
  gameMaze.addObstacle(100,500,100,100);
  gameMaze.addObstacle(500,100,100,100);
  gameMaze.addObstacle(250,250,100,300);
  gameMaze.addObstacle(300,500,100,100);
...
void mouseDragged() {
  ...
  if(gameMaze.checkForObstacleCollision(mouseX,mouseY))
  {
  println("Game Over!");
  trail = null;
  }
