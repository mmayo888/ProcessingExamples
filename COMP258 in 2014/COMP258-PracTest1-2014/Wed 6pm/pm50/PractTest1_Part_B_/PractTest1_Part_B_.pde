//refernece obstacle of class obstacle
Obstacle obstacle1;
...
void setup() {
  ...
  //obstacle created passing in appropriat values
  obstacle1 = new Obstacle(100, 100, #000000, 100, 20);
...
//method to check for collison between obstacle and mouse trial

//void collison()
//{
//  if(obstacle1.pointInToken(mouseX, mouseY))
//  {
//    
//  }
//}
