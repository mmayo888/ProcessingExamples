...
void setup() 
{
  ...
  maze1 = new Maze();
  maze1.addObstacle( 300, 100);
  maze1.addObstacle( 400, 300);
  maze1.addObstacle( 600, 500);
  maze1.addObstacle( 600, 150);
  maze1.addObstacle( 200, 450);
  maze1.addObstacle( 500, 300);
